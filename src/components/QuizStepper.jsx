...
function Stepper() {
  ...
  return (
    <section className="z-10">
      ...
      <div className="w-full sm:w-4/6 flex flex-row items-center justify-start z-10 overflow-x-auto gap-3 sm:gap-0">
        <div className="stepper-item bg-black h-11 w-11 sm:h-10 sm:w-10 lg:w-12 lg:h-12 flex items-center justify-center text-center font-medium border-2 rounded-full min-w-[44px] min-h-[44px] sm:min-w-[40px] lg:min-w-[48px]">
